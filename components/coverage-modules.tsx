...
const MODULES = [
  {
    ...
    details: {
      coverage: "피보험자가 보험기간 중에 발생한 급격하고도 우연한 외래의 사고로 인하여 신체에 상해를 입고 그 직접결과로서 사망한 경우에 보험금을 지급합니다.",
      exclusions: "피보험자의 고의, 전쟁, 혁명, 내란, 자연재해로 인한 사고는 보상하지 않습니다.",
  ...
  },
  {
    ...
    details: {
      coverage: "피보험자가 보험기간 중에 발생한 급격하고도 우연한 외래의 사고로 인하여 골절로 진단 확정된 경우 보험금을 지급합니다.",
      exclusions: "치아, 치조골의 골절 및 병적 골절은 보장하지 않습니다.",
  ...
  },
  {
    ...
    details: {
      coverage: "피보험자가 보험기간 중에 발생한 급격하고도 우연한 외래의 사고로 인하여 응급실에 내원하여 진료를 받은 경우 보험금을 지급합니다.",
